...
public class CDItemTags extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(Tags.Items.DRINKS)
                .add(CDModItems.KELP_SHAKE.get())
                .add(CDModItems.SEA_PICKLE_JUICE.get())
                .add(CDModItems.COCONUT_MILK.get());
        ...
        tag(Tags.Items.FOODS)
                ...
                .add(CDModItems.RAW_GLOW_SQUID_TENTACLES.get())
                .add(CDModItems.COOKED_GLOW_SQUID_TENTACLES.get())
                .add(CDModItems.RAW_FROG_LEG.get())
                .add(CDModItems.COOKED_FROG_LEG.get())
                .add(CDModItems.FRIED_FISH.get())
                .add(CDModItems.KELP_SHAKE.get())
                .add(CDModItems.COCONUT_MILK.get())
                .add(CDModItems.COCONUT_PUDDING.get())
                .add(CDModItems.COOKED_TROPICAL_FISH.get())
                .add(CDModItems.COOKED_TROPICAL_FISH_SLICE.get())
                .add(CDModItems.TROPICAL_FISH_SLICE.get())
                .add(CDModItems.COOKED_PUFFERFISH_SLICE.get())
                .add(CDModItems.PUFFERFISH_SLICE.get())
                .add(CDModItems.COCONUT_HALVE.get())
                .add(CDModItems.CRAB_LEGS.get())
                .add(CDModItems.SHRIMP_SKEWER.get())
                .add(CDModItems.SHRIMP_FRIED_RICE.get())
                .add(CDModItems.SURF_AND_TURF.get())
                .add(CDModItems.CLAM_BAKE.get())
                .add(CDModItems.CLAM_CHOWDER.get())
                .add(CDModItems.BISQUE.get())
                .add(CDModItems.SEAFOOD_GUMBO.get())
                .add(CDModItems.FISH_STICK.get())
                .add(CDModItems.CRAB_CAKES.get())
                .add(CDModItems.STUFFED_NAUTILUS_SHELL.get())
                .add(CDModItems.JAR_OF_PICKLES.get())
                .add(CDModItems.SEA_PICKLE_JUICE.get())
