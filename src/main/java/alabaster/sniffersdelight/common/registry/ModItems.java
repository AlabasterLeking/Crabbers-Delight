...
import alabaster.sniffersdelight.common.CDFoodValues;
...
public class ModItems {
    ...
    public static Item.Properties basicItem() {
        return new Item.Properties().tab(SniffersDelight.TAB);
    }

    // Foods
    public static Item.Properties foodItem(FoodProperties food) {
        return new Item.Properties().food(food).tab(SniffersDelight.TAB);
    }

    // Drinks
    public static Item.Properties drinkItem(FoodProperties food) {
        return new Item.Properties().food(food).craftRemainder(Items.GLASS_BOTTLE).stacksTo(16).tab(SniffersDelight.TAB);
    }
